 ...
 implements RedPic.RemoteOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    _methods.put ("uploadImg", new java.lang.Integer (0));
    _methods.put ("uploadImage", new java.lang.Integer (1));
    _methods.put ("addClient", new java.lang.Integer (2));
    _methods.put ("removeClient", new java.lang.Integer (3));
  }
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    {
       case 0:  // RedPic/Remote/uploadImg
       {
       ...
       case 1:  // RedPic/Remote/uploadImage
       {
         String img = in.read_string ();
       ...
       case 2:  // RedPic/Remote/addClient
       {
       ...
       case 3:  // RedPic/Remote/removeClient
       {
         RedPic.RedPicClient client = RedPic.RedPicClientHelper.read (in);
